...
const Consultation = () => {
  ...
  const handleStartConsultation = async () => {
    ...
    setProcessing(true);
    try {
      const { data, error } = await supabase.rpc("perform_consultation", {
        _doctor_id: doctorId,
      });
        ...
        <div className="p-4 md:p-6 space-y-6">
          <div>
            ...
            <p className="text-muted-foreground leading-7">
              {doctor.bio_ar || "لا توجد معلومات إضافية"}
            </p>
          </div>
              ...
              <AlertDialogContent>
                <AlertDialogHeader>
                  ...
                  <AlertDialogDescription>
                    ...
                    <br />
                    سيتم خصم{" "}
                    {doctor.consultation_fee || doctor.price} جنيه من رصيدك.
                  </AlertDialogDescription>
                </AlertDialogHeader>
                <AlertDialogFooter>
